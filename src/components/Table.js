...
import { ActionExpenseDelete, btnAction } from '../actions';
...
const mapDispatchToProps = (dispatch) => ({
  deleteExpense: (id) => dispatch(ActionExpenseDelete(id)),
  editBtn: (toogle, objectElement) => dispatch(btnAction(toogle, objectElement)),
});
