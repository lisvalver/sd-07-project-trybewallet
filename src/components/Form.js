...
import { CurrenciesAction,
  ActionEx, editAction } from '../actions';
...
const mapDispatchToProps = (dispatch) => ({
  fetchCurrencies: () => dispatch(CurrenciesAction()),
  fetchExchangeRates: (objExpenses) => dispatch(ActionEx(objExpenses)),
  editExpense: (objExpenses) => dispatch(editAction(objExpenses)),
});
